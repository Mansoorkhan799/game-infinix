...
export const metadata: Metadata = {
  title: 'Contact Us - Game Infinix | Get Help & Support',
  description: 'Contact Game Infinix support team for help with the app, content, privacy policy, and more. We are here to assist you.',
  keywords: 'contact game infinix, game infinix support, game infinix email, customer support, help game infinix',
  openGraph: {
    title: 'Contact Us - Game Infinix',
    description: 'Get in touch with Game Infinix support team for any queries or assistance.',
    url: 'https://gameinfinix.net.pk/contact-us',
  ...
  alternates: {
    canonical: 'https://gameinfinix.net.pk/contact-us',
  },
  robots: {
    index: true,
    follow: true,
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-secondary rounded-xl p-6 md:p-8 border-2 border-orange-200 overflow-hidden">
                ...
                <div className="flex justify-center w-full min-w-0 overflow-hidden px-4">
                  <a
                    href="mailto:support@gameinfinix.net.pk"
                  ...
                  >
                    ...
                    <span className="break-all">support@gameinfinix.net.pk</span>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-secondary rounded-xl shadow-lg p-6 text-center hover:shadow-2xl transition-shadow duration-300">
              ...
              <p className="text-gray-400 mb-4">Need help with the Game Infinix app?</p>
